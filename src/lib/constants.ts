...
export const INTRO_OPPORTUNITY =
  "كل شاغر تفتحه هو قرار استثماري مرتبط بهيكلة معتمدة، وميزانية محددة، وأثر واضح. هذا النموذج يضمن أن قرار التوظيف يمر بمسار اعتمادات محوكم قابل للمراجعة، بما يدعم نمونا واستدامتنا. الشركة الاستثنائية لا تُبنى بالتوظيف الكثير، بل بالتوظيف الصح.";

export const HIRING_BAR_MESSAGE =
  "فكّر بكل توظيف سابق لك كان ناجحًا وكل توظيف كان غير استثنائي، وشاركنا مستهدفاتك هذه المرة برفع المعيار بالاختيار لجذب أفضل المواهب والمحافظة عليها.";
